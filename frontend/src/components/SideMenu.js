...
function SideMenu() {
  ...
  const profileImage = localStorageData.imageUrl || "https://ui-avatars.com/api/?name=" + localStorageData.firstName + "+" + localStorageData.lastName + "&background=4F46E5&color=fff";
      ...
      <div className="sticky inset-x-0 bottom-0 border-t border-gray-100">
        <div className="flex items-center gap-2 bg-white p-4 hover:bg-gray-50">
          <img
            ...
            onError={(e) => {
              e.target.src = "https://ui-avatars.com/api/?name=" + localStorageData.firstName + "+" + localStorageData.lastName + "&background=4F46E5&color=fff";
            }}
          />
