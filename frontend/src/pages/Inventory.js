...
function Inventory() {
  ...
  const deleteProductModalSetting = (product) => {
  ...
  const confirmDelete = () => {
    setIsDeleting(true);
    fetch(`http://localhost:4000/api/product/delete/${deleteProduct._id}`)
      .then((response) => response.json())
      .then((data) => {
                ...
                products.map((element) => {
                  return (
                    <tr key={element._id}>
                      ...
                      <td className="whitespace-nowrap px-4 py-2 text-gray-700">
                        <span className={`${element.stock < 10 ? 'text-red-600 font-semibold' : ''}`}>
                          {element.stock || 0}
                        </span>
                      </td>
                      <td className="whitespace-nowrap px-4 py-2 text-gray-700">
                      ...
                      <td className="whitespace-nowrap px-4 py-2 text-gray-700">
                        ...
                        <span
                          className="text-red-600 px-2 cursor-pointer hover:underline"
                          onClick={() => deleteProductModalSetting(element)}
                        >
                          Delete
                        </span>
                      </td>
